...
from f412.models import PNEvol, oldHour, planesCount, areaCaus, costeHora, codCaus, paretoDefecto, paretoTabla, Reparacion, f412Ant, Programa, ComponenteAPT5, avion, reasonTree, reasonTreeField, Pieza, tipoUsuario, modificaciones, Componente, myUser, PN, Area, Defecto, Designacion, Estado, SGM, F412, Seccion
...
admin.site.register(oldHour)
admin.site.register(PNEvol)